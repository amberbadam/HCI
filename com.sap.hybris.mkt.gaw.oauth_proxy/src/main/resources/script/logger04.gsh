...
def String body = message.getBody(java.lang.String.class);
 ...
 dumpProperties_HTML("headers", map, sb_html);
    ...
    sb_html.append("<table>\n");
    sb_html.append("<tr><td>ACCESS_TOKEN</td><td>"+TokenContainer.ACCESS_TOKEN+"</td></tr>\n");
    sb_html.append("<tr><td>REFRESH_TOKEN</td><td>"+TokenContainer.REFRESH_TOKEN+"</td></tr>\n");
    sb_html.append("</table>\n");
